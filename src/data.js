...
// NOTE: La bonne réponse varie en longueur - parfois courte, parfois longue !
...
export const database = [
  // --- SESSION 1 : BASES & AR (10 Q) ---
  {
    ...
    options: ["$\\phi = 1$", "$|\\phi| < 1$", "$\\phi > 0$", "$|\\phi| > 1$", "$\\phi^2 < \\sigma^2$"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Forecasting (prédiction avec labels)", "Clustering", "PCA", "Anomaly Detection non supervisée", "K-means"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["$1 - \\phi_1 z - \\phi_2 z^2 = 0$", "$z^2 - \\phi_1 z - \\phi_2 = 0$", "$1 + \\phi_1 z + \\phi_2 z^2 = 0$", "$\\phi_1 z + \\phi_2 z^2 = 1$", "$z - \\phi_1 - \\phi_2 z^2 = 0$"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Indépendant et Identiquement Distribué", "Intégré et Différencié", "Incrémental et Dérivé", "Inversement Distribué", "Itéré et Interpolé"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Oui, car moyenne nulle, variance constante et autocorrélations nulles", "Non", "Seulement s'il est Gaussien", "Seulement si variance nulle", "Ça dépend du contexte"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Un processus stationnaire classique", "Un processus non-stationnaire avec mémoire longue ou racine unitaire", "Un bruit blanc", "Une saisonnalité", "Un MA(1)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["MSE car le carré amplifie les erreurs extrêmes", "MAE", "Huber Loss", "Quantile Loss", "Median Absolute Deviation"],
    correct: 0,
  ...
  // --- SESSION 2 : ARCHITECTURES (15 Q) ---
  {
    ...
    options: ["Mémoire infinie", "Les convolutions sont parallélisables sur GPU", "Pas de poids", "Plus vieux", "Moins de couches"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Sigmoid", "Tanh pour réguler les valeurs entre -1 et 1", "ReLU", "Softmax", "LeakyReLU"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Multiplications répétées par des valeurs propres $< 1$ lors de la BPTT", "L'utilisation de ReLU", "Un learning rate trop grand", "La taille du batch", "La profondeur"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Injecter la notion d'ordre séquentiel dans un modèle invariant par permutation", "Compresser", "Normaliser", "Réduire", "Encoder les valeurs"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Skip Connection (lien résiduel $x + f(x)$)", "MaxPooling", "Dropout", "Flatten", "Batch Norm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Éviter la saturation du Softmax quand le dot product est grand", "Faire une moyenne", "Normaliser la sortie", "Réduire le bruit", "Stabiliser le LR"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Reconstruire les données normales pour avoir une grande erreur sur les anomalies", "Reconstruire les anomalies", "Classifier", "Prédire le futur", "Compresser les anomalies"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Teacher Forcing : on nourrit $y_{t-1}$ (vérité) au lieu de $\\hat{y}_{t-1}$", "Student Learning", "Gradient Clipping", "Batch Norm", "Curriculum Learning"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Transformer sans Positional Encoding (traite l'entrée comme un ensemble)", "RNN", "CNN", "LSTM", "GRU bidirectionnel"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Réduire l'overfitting en désactivant des neurones aléatoirement", "Accélérer", "Augmenter les poids", "Visualiser", "Améliorer le test"],
    correct: 0,
  ...
  // --- SESSION 3 : SSL & REGULARIZATION (15 Q) ---
  {
    ...
    options: ["La similarité avec l'exemple positif par rapport aux négatifs", "L'erreur de reconstruction", "La variance du batch", "L'entropie des embeddings", "La distance totale"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["La cerise sur le gâteau (très peu de bits de feedback par action)", "Le gâteau", "Le glaçage", "L'assiette", "La crème"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Le modèle sort toujours le même vecteur ou utilise un sous-espace réduit", "Le modèle devient trop grand", "La dimension temporelle disparaît", "Le loss devient négatif", "Les embeddings sont petits"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["BYOL / SimSiam (utilise un Teacher momentum à la place)", "SimCLR", "MoCo", "InfoNCE standard", "CPC"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Il supprime des plages temporelles contiguës, forçant l'usage du contexte lointain", "Il est plus rapide", "Il supprime moins", "Il ne modifie pas les poids", "Il s'applique au test"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Apprendre de bonnes représentations via une tâche auxiliaire", "Gagner du temps", "Réduire le dataset", "Éviter l'overfitting", "Accélérer l'inférence"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["La marge minimale entre positif et négatif", "Le learning rate", "L'ancre", "Le nombre de triplets", "La température"],
    correct: 0,
  ...
  // --- DIVERS & MIX (10 Q) ---
  {
    ...
    options: ["Non-stationnaire car la variance augmente linéairement avec $t$", "Stationnaire", "Convergent", "Borné", "Périodique"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Geler le backbone pré-entraîné et entraîner seulement une couche linéaire finale", "Entraîner tout", "Tester sans entraînement", "Fine-tuner tout", "Geler la dernière couche"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["La différenciation $P_t - P_{t-1}$ (rendements/returns)", "Le carré", "L'exponentielle", "La somme cumulée", "Le log seul"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["$1000 \\times 1000$ (1 million d'éléments, complexité quadratique)", "$1000 \\times 64$", "$1000 \\times 1$", "$64 \\times 64$", "$512 \\times 512$"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Ajouter du bruit aléatoire (souvent gaussien)", "Supprimer des points", "Inverser le temps", "Échantillonner", "Normaliser"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Validation Loss (on arrête quand elle remonte)", "Training Loss", "Test Accuracy", "Training Accuracy", "Gradient Norm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Décalage entre entraînement (Teacher Forcing) et test (auto-régressif)", "Surexposition aux données", "Biais dans les poids", "LR inadapté", "Saturation"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Une variation long-terme de la moyenne (direction générale)", "Une variation cyclique courte", "Un bruit aléatoire", "Une erreur de mesure", "Un artefact d'échantillonnage"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Une composante déterministe + un processus MA($\\infty$)", "Un AR(1)", "Une somme de sinus", "Une constante", "ARIMA(1,1,1)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["0 (car $R^2$ compare à la prédiction naïve de la moyenne)", "1", "-1", "0.5", "Indéfini"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["AR(p) car la PACF se coupe après le lag $p$", "MA(q)", "ARMA", "SARIMA", "GARCH"],
    correct: 0,
  ...
  // --- NEW ADDITIONS : SESSION 1 EXTENDED ---
  {
    ...
    options: ["Moyenne variable", "Moyenne linéaire", "Moyenne constante et covariance dépend uniquement du lag $h$", "Distribution Gaussienne", "Autocorrélation nulle"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["La variance est constante", "La série est stationnaire", "La variance augmente linéairement avec $t$ ($Var(X_t) = t\\sigma^2$)", "Elle converge", "Elle est bornée"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["L'autocorrélation est normalisée (valeurs entre -1 et 1)", "L'autocovariance mesure la causalité", "L'autocorrélation est pour les bruits blancs", "Aucune", "L'autocovariance est toujours positive"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Multiplicative", "Additive : Tendance + Saisonnalité + Jours fériés ($\\hat{y} = g(t) + s(t) + h(t)$)", "Purement AR", "Ondelettes", "LSTM"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["AR(p)", "MA(q) (signature théorique d'un processus moyenne mobile)", "Random Walk", "Non stationnaire", "AR intégré"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lisser", "Rendre la série stationnaire en supprimant la tendance", "Augmenter le dataset", "Réduire le bruit", "Calculer la tendance"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["ARIMA", "LSTM", "Filtre de Kalman (estime l'état caché d'un système à partir de mesures bruitées)", "SVM", "Random Forest"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["MSE", "MAE", "MAPE (pourcentage d'erreur relative, indépendant de l'unité)", "RMSE", "R²"],
    correct: 2,
  ...
  // --- NEW ADDITIONS : SESSION 2 EXTENDED ---
  {
    ...
    options: ["GRU a plus de paramètres", "GRU n'a pas de Cell State séparé (fusionne avec hidden state)", "LSTM a 2 portes", "GRU utilise ReLU", "LSTM n'a pas de hidden state"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Chaque canal a son modèle", "Chaque variable traitée par le même Backbone avec poids partagés", "Les canaux sont moyennés", "Suppression des corrélations", "Attention croisée"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Quantités, Kernels, Vecteurs", "Questions, Keys, Values", "Queries, Keys, Values (analogie base de données)", "Quality, Known, Variance", "Quadrants, Keys, Vectors"],
    correct: 2,
  ...
  // --- NEW ADDITIONS : SESSION 3 EXTENDED ---
  {
    ...
    options: ["Sans données", "Utiliser les données pour générer des pseudo-labels automatiquement", "Superviseur humain", "Synonyme de RL", "Labels aléatoires"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Accélérer", "Maintenir une représentation cohérente des clés négatives via moyenne glissante", "Réduire la mémoire", "Encoder le futur", "Augmenter le batch"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Impossible à coder", "L'ECG a une causalité précise (P-QRS-T) qui serait inversée", "Ça ne change rien", "Le signal devient bruité", "La fréquence change"],
    correct: 1,
  ...
  // --- NEW ADDITIONS : SESSION 4 (AVANCÉ / SOTA) ---
  {
    ...
    options: ["Trop de modèles", "L'accumulation d'erreurs (chaque prédiction réinjectée amplifie les erreurs)", "Sur-apprentissage", "Temps de calcul", "Sous-apprentissage"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Un seul modèle", "On entraîne $H$ modèles distincts donc pas d'accumulation d'erreurs", "Moins coûteux", "Plus simple", "Meilleure interprétabilité"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Une prédiction ponctuelle", "Une distribution de probabilité complète (généralise MAE au cas probabiliste)", "La classification", "La vitesse", "La calibration"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Accélère le GPU", "Gère le Distribution Shift en normalisant l'entrée et dé-normalisant la sortie", "Remplace l'Attention", "Supprime le bruit", "Réduit les paramètres"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Augmente la résolution", "Réduit la longueur de séquence et capture la sémantique locale", "Supprime les NaN", "Compresse", "Ajoute du padding"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["L'afficher", "Utiliser des convolutions 2D sur les périodes dominantes (variabilités intra/inter période)", "Réduire la mémoire", "Augmentation", "Pooling spatial"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Transformers indispensables", "Des MLPs simples et bien régularisés peuvent battre les Transformers complexes", "RNN sont le futur", "DL est inutile", "Attention obligatoire"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["MSE", "Cross-Entropy", "Quantile Loss (pénalise asymétriquement selon le percentile voulu)", "L1 Loss", "Hinge Loss"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Toujours", "Pour intégrer des variables exogènes ou statiques dans le décodeur", "Classification", "Jamais", "Seulement images"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Aucune", "Point = une seule valeur ; Probabilistic = une distribution ou intervalle", "Point = futur proche", "Point = classification", "Prob = plus rapide"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Technique de debug", "La fenêtre d'historique utilisée en entrée du modèle", "Fenêtre de prédiction", "Temps d'entraînement", "Validation croisée"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Pas de prévision", "Le masque d'attention est triangulaire (causal) pour ne pas voir le futur", "On voit le futur", "Encodeur obligatoire", "Cross-attention requise"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ça efface l'information d'amplitude (Scale) qu'on perd définitivement", "Trop lent", "Instabilité numérique", "Perte de gradients", "Overfitting"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Apprentissage supervisé renforcé", "Utiliser $y_{t-1}$ (vérité) au lieu de $\\hat{y}_{t-1}$ pendant l'entraînement", "Forcer la convergence", "Régularisation L2", "Data augmentation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["L2 (Ridge)", "L1 (Lasso) car elle tend à annuler les coefficients inutiles", "Dropout", "Adam", "Elastic Net $\\alpha = 0$"],
    correct: 1,
